...
def generate_knn_query(field_name, query_vector, partition_id, k, rescore_oversample, sliced):
    knn_query = {
        "field": field_name,
...
class RandomSearchParamSource:
    ...
    def params(self):
        ...
        if self._sliced:
            params["request-params"] = {"_slice": partition_id}
        return params
