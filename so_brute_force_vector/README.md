## StackOverflow BruteForce vector track

This track benchmarks brute-force vector searches over sorted indices. Unlike the
`so_vector` track, the vectors are not indexed.
